export type Project = {
  ...
  images: string[];
  imageAspects: number[];
  fullWidthFrom?: number;
};

const imageList = (slug: string, count: number) =>
  Array.from({ length: count }, (_, index) => `/projects/${slug}/${String(index + 1).padStart(2, "0")}.webp`);

const completeList = (slug: string, count: number) =>
  Array.from({ length: count }, (_, index) => `/projects/${slug}/full-${String(index + 1).padStart(2, "0")}.webp`);
...
export const projects: Project[] = [
  {
    ...
    services: ["品牌识别", "视觉系统", "空间应用", "礼赠设计"], images: [...imageList("cdn", 2), ...completeList("cdn", 18)],
    imageAspects: [16 / 9, 16 / 9, ...Array(18).fill(1)], fullWidthFrom: 2,
  },
  {
    ...
    services: ["品牌策略", "视觉识别", "包装系统", "IP 形象"], images: [...imageList("guihe", 2), ...completeList("guihe", 18)],
    imageAspects: [3 / 2, 3 / 2, ...Array(18).fill(1)], fullWidthFrom: 2,
  },
  {
    ...
    services: ["字体设计", "标志设计", "字形研究", "场景应用"], images: [...imageList("type", 2), ...completeList("type", 5)],
    imageAspects: [1371 / 1147, 3 / 2, ...Array(5).fill(1)], fullWidthFrom: 2,
  },
  {
    ...
    services: ["海报设计", "书籍封面", "视觉实验", "字体编排"], images: [...imageList("poster", 2), ...completeList("poster", 2)],
    imageAspects: [16 / 9, 3 / 2, ...Array(2).fill(1)], fullWidthFrom: 2,
  },
  {
    ...
    services: ["IP 策略", "角色设计", "场景延展", "衍生应用"], images: [...imageList("xiaoxiao", 2), ...completeList("xiaoxiao", 19)],
    imageAspects: [1537 / 1023, 1537 / 1023, ...Array(19).fill(1)], fullWidthFrom: 2,
  },
];
