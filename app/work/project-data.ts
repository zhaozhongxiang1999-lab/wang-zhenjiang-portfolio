...
export const projects: Project[] = [
  {
    ...
    services: ["品牌识别", "视觉系统", "空间应用", "礼赠设计"], images: [...imageList("cdn", 1), ...completeList("cdn", 19)],
    imageAspects: [16 / 9, ...Array(19).fill(1)], fullWidthFrom: 1,
  },
  {
    ...
    services: ["品牌策略", "视觉识别", "包装系统", "IP 形象"], images: [...imageList("guihe", 1), ...completeList("guihe", 19)],
    imageAspects: [3 / 2, ...Array(19).fill(1)], fullWidthFrom: 1,
  },
  {
  ...
  },
  {
    ...
    services: ["海报设计", "书籍封面", "视觉实验", "字体编排"], images: [...imageList("poster", 1), ...completeList("poster", 3)],
    imageAspects: [16 / 9, ...Array(3).fill(1)], fullWidthFrom: 1,
  },
  {
    ...
    services: ["IP 策略", "角色设计", "场景延展", "衍生应用"], images: [...imageList("xiaoxiao", 1), ...completeList("xiaoxiao", 20)],
    imageAspects: [1537 / 1023, ...Array(20).fill(1)], fullWidthFrom: 1,
  },
];
