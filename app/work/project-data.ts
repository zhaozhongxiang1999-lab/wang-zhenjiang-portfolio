...
const completeList = (slug: string, count: number, start = 1) =>
  Array.from({ length: count }, (_, index) => `/projects/${slug}/full-${String(index + start).padStart(2, "0")}.webp`);
...
export const projects: Project[] = [
  {
    ...
    services: ["品牌识别", "视觉系统", "空间应用", "礼赠设计"], images: [...imageList("cdn", 1), ...completeList("cdn", 17, 2)],
    imageAspects: [16 / 9, ...Array(17).fill(1)], fullWidthFrom: 1,
  },
  {
    ...
    services: ["品牌策略", "视觉识别", "包装系统", "IP 形象"], images: [...imageList("guihe", 1), ...completeList("guihe", 18)],
    imageAspects: [3 / 2, ...Array(18).fill(1)], fullWidthFrom: 1,
  },
  {
    ...
    services: ["字体设计", "标志设计", "字形研究", "场景应用"], images: [...imageList("type", 1), ...completeList("type", 5)],
    imageAspects: [1371 / 1147, ...Array(5).fill(1)], fullWidthFrom: 1,
  },
  {
    ...
    services: ["海报设计", "书籍封面", "视觉实验", "字体编排"], images: [...imageList("poster", 1), ...completeList("poster", 2)],
    imageAspects: [16 / 9, ...Array(2).fill(1)], fullWidthFrom: 1,
  },
  {
    ...
    services: ["IP 策略", "角色设计", "场景延展", "衍生应用"], images: [...imageList("xiaoxiao", 1), ...completeList("xiaoxiao", 19)],
    imageAspects: [1537 / 1023, ...Array(19).fill(1)], fullWidthFrom: 1,
  },
];
